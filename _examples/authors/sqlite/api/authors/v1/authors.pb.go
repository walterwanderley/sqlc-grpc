...
const file_authors_v1_authors_proto_rawDesc = "" +
	...
	"authors.v1\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\\\n" +
	"\x06Author\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12.\n" +
	"\x03bio\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\x03bio\"Y\n" +
	"\x13CreateAuthorRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12.\n" +
	"\x03bio\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x03bio\"D\n" +
	"\x14CreateAuthorResponse\x12,\n" +
	"\x05value\x18\x01 \x01(\v2\x16.authors.v1.ExecResultR\x05value\"%\n" +
	...
	"\x06author\x18\x01 \x01(\v2\x12.authors.v1.AuthorR\x06author\"\x14\n" +
	"\x12ListAuthorsRequest\"=\n" +
	"\x13ListAuthorsResponse\x12&\n" +
	"\x04list\x18\x01 \x03(\v2\x12.authors.v1.AuthorR\x04list\"T\n" +
	"\n" +
	"ExecResult\x12\"\n" +
	"\frowsAffected\x18\x01 \x01(\x03R\frowsAffected\x12\"\n" +
	"\flastInsertId\x18\x02 \x01(\x03R\flastInsertId2\xb0\x03\n" +
	"\x0eAuthorsService\x12e\n" +
	"\fCreateAuthor\x12\x1f.authors.v1.CreateAuthorRequest\x1a .authors.v1.CreateAuthorResponse\"\x12\x82\xd3\xe4\x93\x02\f:\x01*\"\a/author\x12g\n" +
	"\fDeleteAuthor\x12\x1f.authors.v1.DeleteAuthorRequest\x1a .authors.v1.DeleteAuthorResponse\"\x14\x82\xd3\xe4\x93\x02\x0e*\f/author/{id}\x12f\n" +
	"\tGetAuthor\x12\x1c.authors.v1.GetAuthorRequest\x1a\x1d.authors.v1.GetAuthorResponse\"\x1c\x82\xd3\xe4\x93\x02\x16b\x06author\x12\f/author/{id}\x12f\n" +
	"\vListAuthors\x12\x1e.authors.v1.ListAuthorsRequest\x1a\x1f.authors.v1.ListAuthorsResponse\"\x16\x82\xd3\xe4\x93\x02\x10b\x04list\x12\b/authorsB\xee\x01\x92A\xd2\x01\x12\xcf\x01\n" +
