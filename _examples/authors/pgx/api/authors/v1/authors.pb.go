...
type Authors struct {
	...
	Age           *wrapperspb.StringValue `protobuf:"bytes,4,opt,name=age,proto3" json:"age,omitempty"`
...
func (x *Authors) GetAge() *wrapperspb.StringValue {
	if x != nil {
		return x.Age
	}
	return nil
...
const file_authors_v1_authors_proto_rawDesc = "" +
	"\n" +
	"\x18authors/v1/authors.proto\x12\n" +
	"authors.v1\x1a\x1cgoogle/api/annotations.proto\x1a.protoc-gen-openapiv2/options/annotations.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xc8\x01\n" +
	"\aAuthors\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12.\n" +
	"\x03bio\x18\x03 \x01(\v2\x1c.google.protobuf.StringValueR\x03bio\x12.\n" +
	"\x03age\x18\x04 \x01(\v2\x1c.google.protobuf.StringValueR\x03age\x129\n" +
	"\n" +
	"created_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\"\x94\x01\n" +
	"\x13CreateAuthorRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12.\n" +
	"\x03bio\x18\x02 \x01(\v2\x1c.google.protobuf.StringValueR\x03bio\x129\n" +
	"\n" +
	"created_at\x18\x03 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\"E\n" +
	"\x14CreateAuthorResponse\x12-\n" +
	"\aauthors\x18\x01 \x01(\v2\x13.authors.v1.AuthorsR\aauthors\"%\n" +
	"\x13DeleteAuthorRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\"\x16\n" +
	"\x14DeleteAuthorResponse\"\"\n" +
	"\x10GetAuthorRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\"B\n" +
	"\x11GetAuthorResponse\x12-\n" +
	"\aauthors\x18\x01 \x01(\v2\x13.authors.v1.AuthorsR\aauthors\"\x14\n" +
	"\x12ListAuthorsRequest\">\n" +
	"\x13ListAuthorsResponse\x12'\n" +
	"\x04list\x18\x01 \x03(\v2\x13.authors.v1.AuthorsR\x04list\"X\n" +
	"\x16UpdateAuthorBioRequest\x12.\n" +
	"\x03bio\x18\x01 \x01(\v2\x1c.google.protobuf.StringValueR\x03bio\x12\x0e\n" +
	"\x02id\x18\x02 \x01(\x03R\x02id\"\x19\n" +
	"\x17UpdateAuthorBioResponse2\xb7\x04\n" +
	"\x0eAuthorsService\x12o\n" +
	"\fCreateAuthor\x12\x1f.authors.v1.CreateAuthorRequest\x1a .authors.v1.CreateAuthorResponse\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*b\aauthors\"\b/authors\x12h\n" +
	"\fDeleteAuthor\x12\x1f.authors.v1.DeleteAuthorRequest\x1a .authors.v1.DeleteAuthorResponse\"\x15\x82\xd3\xe4\x93\x02\x0f*\r/authors/{id}\x12h\n" +
	"\tGetAuthor\x12\x1c.authors.v1.GetAuthorRequest\x1a\x1d.authors.v1.GetAuthorResponse\"\x1e\x82\xd3\xe4\x93\x02\x18b\aauthors\x12\r/authors/{id}\x12f\n" +
	"\vListAuthors\x12\x1e.authors.v1.ListAuthorsRequest\x1a\x1f.authors.v1.ListAuthorsResponse\"\x16\x82\xd3\xe4\x93\x02\x10b\x04list\x12\b/authors\x12x\n" +
	"\x0fUpdateAuthorBio\x12\".authors.v1.UpdateAuthorBioRequest\x1a#.authors.v1.UpdateAuthorBioResponse\"\x1c\x82\xd3\xe4\x93\x02\x16:\x01*2\x11/authors/{id}/bioB\xee\x01\x92A\xd2\x01\x12\xcf\x01\n" +
	"\aauthors\x12\x83\x01Boilerplate code generated by **sqlc-grpc**. Modify _proto/*.proto_ files then run `buf generate` to change the services interface.\"9\n" +
	"\tsqlc-grpc\x12,https://github.com/walterwanderley/sqlc-grpc2\x031.0Z\x16authors/api/authors/v1b\x06proto3"
...
var file_authors_v1_authors_proto_depIdxs = []int32{
	...
	11, // 1: authors.v1.Authors.age:type_name -> google.protobuf.StringValue
	12, // 2: authors.v1.Authors.created_at:type_name -> google.protobuf.Timestamp
	11, // 3: authors.v1.CreateAuthorRequest.bio:type_name -> google.protobuf.StringValue
	12, // 4: authors.v1.CreateAuthorRequest.created_at:type_name -> google.protobuf.Timestamp
	0,  // 5: authors.v1.CreateAuthorResponse.authors:type_name -> authors.v1.Authors
	0,  // 6: authors.v1.GetAuthorResponse.authors:type_name -> authors.v1.Authors
	0,  // 7: authors.v1.ListAuthorsResponse.list:type_name -> authors.v1.Authors
	11, // 8: authors.v1.UpdateAuthorBioRequest.bio:type_name -> google.protobuf.StringValue
	1,  // 9: authors.v1.AuthorsService.CreateAuthor:input_type -> authors.v1.CreateAuthorRequest
	3,  // 10: authors.v1.AuthorsService.DeleteAuthor:input_type -> authors.v1.DeleteAuthorRequest
	5,  // 11: authors.v1.AuthorsService.GetAuthor:input_type -> authors.v1.GetAuthorRequest
	7,  // 12: authors.v1.AuthorsService.ListAuthors:input_type -> authors.v1.ListAuthorsRequest
	9,  // 13: authors.v1.AuthorsService.UpdateAuthorBio:input_type -> authors.v1.UpdateAuthorBioRequest
	2,  // 14: authors.v1.AuthorsService.CreateAuthor:output_type -> authors.v1.CreateAuthorResponse
	4,  // 15: authors.v1.AuthorsService.DeleteAuthor:output_type -> authors.v1.DeleteAuthorResponse
	6,  // 16: authors.v1.AuthorsService.GetAuthor:output_type -> authors.v1.GetAuthorResponse
	8,  // 17: authors.v1.AuthorsService.ListAuthors:output_type -> authors.v1.ListAuthorsResponse
	10, // 18: authors.v1.AuthorsService.UpdateAuthorBio:output_type -> authors.v1.UpdateAuthorBioResponse
