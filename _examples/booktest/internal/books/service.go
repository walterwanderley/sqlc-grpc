...
func (s *Service) BooksByTags(ctx context.Context, in *pb.BooksByTagsParams) (*pb.BooksByTagsResponse, error) {
...
func (s *Service) BooksByTitleYear(ctx context.Context, in *pb.BooksByTitleYearParams) (*pb.BooksByTitleYearResponse, error) {
...
func (s *Service) CreateAuthor(ctx context.Context, in *pb.CreateAuthorParams) (*pb.Author, error) {
	name := in.GetName()
...
func (s *Service) CreateBook(ctx context.Context, in *pb.CreateBookParams) (*pb.Book, error) {
...
func (s *Service) DeleteBook(ctx context.Context, in *pb.DeleteBookParams) (*emptypb.Empty, error) {
	bookID := in.GetBookID()
...
func (s *Service) GetAuthor(ctx context.Context, in *pb.GetAuthorParams) (*pb.Author, error) {
...
func (s *Service) GetBook(ctx context.Context, in *pb.GetBookParams) (*pb.Book, error) {
	bookID := in.GetBookID()
...
func (s *Service) UpdateBook(ctx context.Context, in *pb.UpdateBookParams) (*emptypb.Empty, error) {
...
func (s *Service) UpdateBookISBN(ctx context.Context, in *pb.UpdateBookISBNParams) (*emptypb.Empty, error) {
